-- ============================================================
--  MIGRATION V3 — Self-healing schema (idempotent)
--  Run via Supabase Dashboard SQL editor for each tenant.
...
-- ── 5) Missing columns on categories ──
