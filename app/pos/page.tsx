                    ...
                    <div className="pt-2 space-y-2">
                      ...
                      <a
                        href={`https://wa.me/${selectedOrder.customerPhone.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(
                          `طلب توصيل #${selectedOrder.orderNumber}\n${selectedOrder.deliveryLat && selectedOrder.deliveryLng ? `الموقع: https://www.google.com/maps?q=${selectedOrder.deliveryLat},${selectedOrder.deliveryLng}` : ""}`
                        )}`}
