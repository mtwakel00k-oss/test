...
import { ChartNoAxesColumn, ShoppingBag, ClipboardList, Shield, BarChart3, Users, Percent, FileText } from "lucide-react"
...
export function TenantSidebar({ currentTab, onTabChange, userRole, labels }: TenantSidebarProps) {
  ...
  const items: SidebarItem[] = [
    ...
    { id: "reports", label: labels.reports || "Reports", icon: <FileText className="size-4" strokeWidth={1.5} />, adminOnly: true },
  ]
