...
const SidebarTrigger = React.forwardRef<HTMLButtonElement, React.ComponentProps<"button">>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <button ref={ref} data-sidebar="trigger" onClick={(e) => { onClick?.(e); toggleSidebar() }} className={cn("flex h-7 w-7 items-center justify-center rounded-md text-sidebar-foreground/70 hover:text-sidebar-foreground transition-colors", className)} {...props}>
