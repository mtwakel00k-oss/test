...
function SkeletonCard() {
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-border/20 bg-card shadow-sm">
      <div className="aspect-[4/3] bg-gradient-to-br from-primary/[0.04] to-primary/[0.08] animate-pulse" />
      <div className="space-y-3 p-5">
        <div className="h-5 w-2/3 rounded-full bg-muted/40 animate-pulse" />
        ...
        <div className="h-12 w-full rounded-full bg-muted/30 animate-pulse mt-3" />
      </div>
    </div>
  )
}
      ...
      <div className="relative mx-auto max-w-5xl px-4 pb-36 pt-10 md:px-8 md:pt-14">
        <div className="mb-10 md:mb-14">
          <div className="flex items-center gap-2 mb-4">
            <div className="h-px w-10 rounded-full bg-muted/30 animate-pulse" />
            <div className="size-3.5 rounded-full bg-muted/30 animate-pulse" />
          </div>
          <div className="h-12 w-48 rounded-full bg-muted/30 animate-pulse" />
          <div className="mt-3 h-4 w-96 max-w-full rounded-full bg-muted/20 animate-pulse" />
        </div>
